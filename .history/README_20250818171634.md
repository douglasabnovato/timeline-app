...
#### 🔐 Criptografar senhas: Mesmo em ambiente local, usar bcrypt para não salvar senhas em texto plano.
#### 🧪 Testes manuais: Criar cenários de teste para login, registro, publicação e visualização.
#### 📦 Futuro com banco real: Quando quiser escalar, migrar para MongoDB ou SQLite será natural.
#### 🧱 Separar camadas: Backend com rotas e serviços separados, frontend com hooks e contextos organizados.